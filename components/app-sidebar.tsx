...
export default function AppSidebar() {
  ...
  useEffect(() => {
    const savedTheme =
      localStorage.getItem("canteen-theme");
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className="fixed left-0 right-0 top-0 z-40 flex h-16 items-center justify-between border-b border-[var(--border)] bg-[var(--card)] px-4 lg:hidden">
      ...
      {/* Mobile Controls */}
      <div className="flex h-16 items-center justify-end border-b border-[var(--border)] bg-[var(--card)] px-4 lg:hidden">
